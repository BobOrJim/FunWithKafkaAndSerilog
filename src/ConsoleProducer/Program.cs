...
namespace ConsoleProducer
{
    class Program
    {
        //public ProducerConfig config = new ProducerConfig { BootstrapServers = "localhost:9092" };
        static void Main(string[] args)
        {
            ...
            //IConfiguration configuration = new ConfigurationBuilder().AddIniFile(myargs).Build();
